...
class ModelTrainer {
    ...
    constructor(params = {}) {
        this.coinApiSDK = new CoinApiSDK(params.coinAPIKey);
        const {
    ...
    trainForML(params) {
        ...
        const trainParams = {
            ...
            dataSchema: mlConfig.dataSchemas.base,
            modelDataRearrangement: mlConfig.dataRearrangement.base.model,
            evaluationDataRearrangement: mlConfig.dataRearrangement.base.evaluation,
            modelRecipe: mlConfig.modelRecipes.base,
            modelParameters: mlConfig.modelParams.base
        };
...
//                .then((data) => this.saveToFile(data))
                ...
                .then(() => this.machineLearning.train(trainParams))
    }

    gatherCSVData(params) {
        console.log(`ModelTrainer::gatherCSVData`);
        return this.fetchData(params)
                .then((cleanJsonData) => this.converToCSV(cleanJsonData))
                .then((csvData) => this.saveCSVToFile(csvData));
    }
